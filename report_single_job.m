...
newICAP2=icap;
newICAP2.year= repmat(current_year,height(icap),1);
for i=1:Periods
    ...
    new_icap.year= repmat(years(i),height(new_icap),1);
    newICAP2=[newICAP2;new_icap];
end

% generation
generation= cc.(a).o.MWh_year.y2020; 
emissions= cc.(a).o.emissions.y2020;
for i=2:Periods
    current_year = strcat('y',string(years(i)));
    generation2= cc.(a).o.MWh_year.(current_year); 
    generation= [generation;generation2];
    emissions2= cc.(a).o.emissions.(current_year);
